...
public class KickAssemblerAddressOperandImpl extends ASTWrapperPsiElement implements KickAssemblerAddressOperand {

  public KickAssemblerAddressOperandImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KickAssemblerVisitor visitor) {
    visitor.visitAddressOperand(this);
  }
