...
public class KickAssemblerModuleBuilder extends ModuleBuilder implements ModuleBuilderListener {
    ...
    public void setupRootModel(@NotNull ModifiableRootModel modifiableRootModel) throws ConfigurationException {
        ...
        if (contentEntryPath != null) {
            VirtualFile root = localFileSystem.refreshAndFindFileByPath(toSystemIndependentName(contentEntryPath));
    ...
    @Contract(" -> new")
    private @NotNull VelocityContext createVelocityContext() {
